(function( $, window, document, undefined ) {
  ...
  'use strict';
    ...
    var defaults = {drag_disabled: true};
    ...
    $.extend( Plugin.prototype, {
      ...
      renderMarkup: function() {
        ...
        var $image_box =                    $('<div id="image-map-container" class="image-marker-container__box--image"></div>');
        ...
        $container.append($left_box_wrapper).append($image_box).append($right_box_wrapper);
      ...
      addTextbox: function(marker) {
        ...
        var $title = $('<h2 class="image-marker__text-box__title" contenteditable="true">Location - </h2>');
