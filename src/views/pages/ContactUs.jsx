...
import { FaEnvelope, FaBuilding, FaPhone } from "react-icons/fa"; // Importing React Icons
      ...
      <div className="row g-3">
        <div className="col-md-8">
          <div className="card">
            <div className="card-header theme-1 text-light">
              <FaEnvelope /> Send Message {/* Using React Icon */}
            </div>
        ...
        <div className="col-md-4">
          <div className="card mb-3">
            <div className="card-header theme-1 text-light">
              <FaBuilding /> Address {/* Using React Icon */}
            </div>
            <div className="card-body">
              ...
              <address>
                ...
                <br />
                <FaPhone /> <abbr title="Phone">P:</abbr> (123) 456-7890 {/* Using React Icon */}
              </address>
              <h6 className="card-title border-bottom border-dark pb-2">
                Development Office
              </h6>
